...
public:
	 ...
	 */
	Sdhc_SPI (Name spiPortName, unsigned char pinMosiNr, unsigned char pinSckNr, Name devicePortName, unsigned char pinCsNr);
	
	#ifdef UART_DEBUG
	/** 
	 * @brief Setter for debug usart object.
	 */
	inline void setUsartDebug (Usart * usartDebug) { usart = usartDebug; };
	#endif
	 ...
	 */
	inline CardStatus getCardStatus () const { return cardStatus; };
