...
void RealTimeClock::setupTimer1 ()
{
	...
	{
		case System::PRE_1: OCR1A = F_CRYSTAL * 1000; break;
		case System::PRE_2: OCR1A = F_CRYSTAL * 500; break;
		case System::PRE_4: OCR1A = F_CRYSTAL * 250; break;
		case System::PRE_8: OCR1A = F_CRYSTAL * 125; break;
	}
...
AnalogComparator::AnalogComparator(IOPort::Name pinAin0Name, unsigned char pinAin0Nr, IOPort::Name pinAin1Name, unsigned char pinAin1Nr):
	pinAin0(pinAin0Name, pinAin0Nr, IOPort::INPUT),
	pinAin1(pinAin1Name, pinAin1Nr, IOPort::INPUT)
{
