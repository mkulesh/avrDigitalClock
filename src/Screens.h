...
public:
    enum Element
    {
        TS_DAY = 0, TS_MONTH = 1, TS_YEAR = 2, TS_HOUR = 3, TS_MIN = 4, TS_SEC = 5
    };
    ...
    {
        activeElement = TS_DAY;
    };
    inline void setActiveElement(Element element)
    {
...
public:
    ...
    inline unsigned char manValue()
    {
        return data.manValue;
    };
    void setFirst();
    void setNext();
    void fillLine(int line, const DisplayDataProvider * dataProvider, char * dest);
